  ...
  return (
    <ScrollView style={styles.container}>
     <View style={{marginTop:60}} >
      ...
      <Text style={styles.textstyle}>  Bus Tracking System</Text>
{/* <View style={{backgroundColor:'black',margin:2}}>
  ...
  <Button title="Driver's Login" color="lightblue" style={{ padding: 10, color: 'pink' }}onPress={()=> navigation.push('Loginpage')} />
  ...
  <View style={styles.buttonstyle}>
  <Button   title="Student's Login "  color='lightblue'   style={{ padding: 10, backgroundColor:'blue',color:'white' } } onPress={()=> navigation.push('StudentLogin')}
